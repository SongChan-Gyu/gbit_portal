...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "지비아이티 임직원 전용 사이트",
    description: "지비아이티 포털 — 휴가·결재·제주 숙소·근태를 한 곳에서 관리합니다.",
    url: "https://www.gbitportal.co.kr",
    siteName: "GBIT Portal",
    locale: "ko_KR",
    type: "website",
    images: [
      {
        url: "https://www.gbitportal.co.kr/gbit-og-v2.png",
        secureUrl: "https://www.gbitportal.co.kr/gbit-og-v2.png",
        width: 1024,
        height: 571,
        type: "image/png",
        alt: "GBIT Portal",
  ...
  twitter: {
    ...
    images: ["https://www.gbitportal.co.kr/gbit-og-v2.png"],
  },
};
