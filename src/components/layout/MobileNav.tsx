...
const NAV_ITEMS: NavItem[] = [
  ...
  { href: "/attendance", label: "근태 현황", roles: ["TEAM_LEAD","PM","ADMIN"] },
  ...
  { href: "/test/impersonate", label: "결재 테스트", roles: ["ADMIN"] },
];
    ...
    <div className="fixed inset-0 z-50 md:hidden">
      ...
      <div className="fixed inset-y-0 left-0 w-[min(280px,85vw)] bg-slate-800 flex flex-col">
        <div className="flex items-center justify-between px-5 py-5 border-b border-slate-700">
          <span className="font-bold text-white text-[17px]">HRM 시스템</span>
